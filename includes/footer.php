    ...
    <div class="container-fluid text-center  text-white" style="background-color: #0d8592;">
        ...
        <div class=" row">
            ...
            <div class="col-sm-4">
                ...
                <br>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <a href="https://www.facebook.com/" style="color: white; margin-right :20px;"> <i class="fab fa-facebook fa-3x">&nbsp;</i></a>
                <a href="https://www.instagram.com/sinhgadcollegepune/?hl=en" style="color: white; margin-right :20px;"><i class="fab fa-instagram fa-3x">&nbsp;</i></a>
                <a href="https://twitter.com/" style="color: white; margin-right :20px;"><i class="fab fa-twitter fa-3x"></i></a>
            </div>
        </div>
        <br><br>
        <div class="row">
...
<div class="footer-copyright text-center py-3 " style="background-color:#086a76;">© 2022 Copyright:
    <a href="http://localhost/PharmEasy-master/index.php" target="_blank" style="color: white; text-decoration: none;">Pharmeasy.in</a>
</div>
